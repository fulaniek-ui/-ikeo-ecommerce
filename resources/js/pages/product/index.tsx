...
import { PackagePlus, Search, LayoutGrid, Package, Hash, TrendingUp } from 'lucide-react';
  ...
  return (
    <AppLayout breadcrumbs={[{ title: 'Products overview', href: '/dashboard/products' }]}>
      ...
      <div className="space-y-6 p-6 sm:p-8 lg:p-10">
        ...
        {/* Hero Banner */}
        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-amber-500 via-orange-500 to-rose-600">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-amber-100/70 text-sm mt-0.5">
                  Manage inventory, pricing, and product variants
                </p>
              </div>
            </div>
            <Link href="/dashboard/products/create">
              <Button size="lg" className="rounded-xl bg-white text-amber-700 hover:bg-amber-50 shadow-lg shadow-black/10 hover:-translate-y-0.5 transition-all h-12 font-bold px-6">
          ...
          <div className="relative grid grid-cols-3 border-t border-white/10">
            {[
              { label: 'Total Products', value: products.total, icon: Package },
              { label: 'Current Page', value: `${products.current_page} / ${products.last_page}`, icon: Hash },
              { label: 'Showing', value: `${products.data.length} items`, icon: TrendingUp },
            ].map((s) => (
